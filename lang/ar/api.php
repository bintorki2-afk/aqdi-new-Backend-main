...
return [
    ...
    'otp_locked' => 'تم تجاوز عدد المحاولات المسموح بها، حاول مرة أخرى بعد :minutes دقيقة',
    'otp_invalid_with_attempts' => 'رمز التحقق غير صحيح، تبقى لديك :remaining محاولات',
    'otp_wait_before_resend' => 'يرجى الانتظار قبل طلب رمز تحقق جديد.',
    'otp_send_rate_limited' => 'تم تجاوز الحد المسموح لإرسال رمز التحقق، حاول لاحقاً',
    ...
    'refund_requires_paid_contract' => 'لا يمكن إنشاء طلب استرجاع إلا لعقد مدفوع',
    'refund_amount_exceeds_paid' => 'مبلغ الاسترجاع (:amount ر.س هو الحد الأقصى) لا يمكن أن يتجاوز المبلغ المدفوع فعلياً',
