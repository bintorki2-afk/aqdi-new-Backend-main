...
return [
    ...
    'otp_locked' => 'Too many incorrect attempts. Try again in :minutes minutes',
    'otp_invalid_with_attempts' => 'The verification code is incorrect. You have :remaining attempts left',
    'otp_wait_before_resend' => 'Please wait before requesting a new verification code.',
    'otp_send_rate_limited' => 'You have requested too many verification codes. Try again later',
    ...
    'refund_requires_paid_contract' => 'A refund can only be created for a paid contract',
    'refund_amount_exceeds_paid' => 'Refund amount cannot exceed the amount actually paid (:amount SAR)',
